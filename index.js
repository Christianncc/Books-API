...
const db = new pg.Client({
  user: "postgres", // The username for the PostgreSQL connection.
  host: "localhost", // The host where the PostgreSQL database is running, set to local machine.
  database: "books", // The name of the PostgreSQL database to connect to.
  password: "12345", // The password for the PostgreSQL user.
